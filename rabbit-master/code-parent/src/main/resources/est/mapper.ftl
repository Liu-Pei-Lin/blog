...
<mapper namespace="cn.${package}.mapper.${table.className}Mapper">
    ...
    <select id="get${table.className}ListByMap" resultType="cn.${package}.model.po.${table.className}"
        ...
        <trim prefix="where" prefixOverrides="and | or">
            <#list table.cloumns as cloumn>
                <#if cloumn.cloumnType=='BIGINT' || cloumn.cloumnType=='INT' || cloumn.cloumnType=='DECIMAL' || cloumn.cloumnType=='DOUBLE'>
                    <if test="${cloumn.fieldName} != null">
                        and ${cloumn.cloumnName}=${r"#{"}${cloumn.fieldName}}
                    </if>
                <#elseif cloumn.cloumnType=='DATETIME'|| cloumn.cloumnType=='DATE' || cloumn.cloumnType=='TIMESTAMP'>
